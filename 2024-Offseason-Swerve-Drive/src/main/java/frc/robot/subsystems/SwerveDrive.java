...
public class SwerveDrive extends SubsystemBase {
  ...
  public SwerveDrive() {
    ...
    // odometry = new SwerveDriveOdometry(kinematics, pigeon.getRotation2d(), bew
    // SwerveModulePosition[]{modules[0].g})

  }

  public void drive(ChassisSpeeds desiredChassisSpeeds) {
    ChassisSpeeds speeds = ChassisSpeeds.fromFieldRelativeSpeeds(desiredChassisSpeeds, pigeon.getRotation2d());
